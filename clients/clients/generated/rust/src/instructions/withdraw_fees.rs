...
#[inline(always)]
    pub fn fee_authority(&mut self, fee_authority: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn program_fee_ata(&mut self, program_fee_ata: solana_program::pubkey::Pubkey) -> &mut Self {
...
#[inline(always)]
    pub fn fee_authority(&mut self, fee_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn program_fee_ata(&mut self, program_fee_ata: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.program_fee_ata = Some(program_fee_ata);
                    self
    }
      #[inline(always)]
    pub fn admin_fee_ata(&mut self, admin_fee_ata: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          program_fee_ata: self.instruction.program_fee_ata.expect("program_fee_ata is not set"),
                  
          admin_fee_ata: self.instruction.admin_fee_ata.expect("admin_fee_ata is not set"),
