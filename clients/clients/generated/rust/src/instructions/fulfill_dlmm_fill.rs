...
impl FulfillDlmmFill {
  pub fn instruction(&self, args: FulfillDlmmFillInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: FulfillDlmmFillInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = FulfillDlmmFillInstructionData::new().try_to_vec().unwrap();
...
#[inline(always)]
    pub fn fee_authority(&mut self, fee_authority: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn fee_ata(&mut self, fee_ata: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
