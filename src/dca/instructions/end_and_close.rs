...
#[inline(always)]
    pub fn user_out_ata(&mut self, user_out_ata: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
            ...
            /// `[optional account]`
#[inline(always)]
    pub fn init_user_out_ata(&mut self, init_user_out_ata: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
...
#[inline(always)]
    pub fn user_out_ata(&mut self, user_out_ata: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
      ...
      /// `[optional account]`
#[inline(always)]
    pub fn init_user_out_ata(&mut self, init_user_out_ata: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
