...
use crate::dca::types::WithdrawParams;
...
pub struct Withdraw {
          ...
          pub dca_ata: solana_program::pubkey::Pubkey,
          
              
          pub user_in_ata: Option<solana_program::pubkey::Pubkey>,
  ...
  pub fn instruction_with_remaining_accounts(&self, args: WithdrawInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    let mut accounts = Vec::with_capacity(12 + remaining_accounts.len());
            ...
            false
                                                      ...
                                                      if let Some(user_in_ata) = self.user_in_ata {
              accounts.push(solana_program::instruction::AccountMeta::new(
                user_in_ata,
                false,
              ));
...
///
          ...
          ///   3. `[]` output_mint
                ///   4. `[writable]` dca_ata
                      ///   5. `[writable, optional]` user_in_ata
                      ///   6. `[writable, optional]` user_out_ata
          ///   7. `[]` system_program
          ///   8. `[]` token_program
...
pub struct WithdrawBuilder {
            user: Option<solana_program::pubkey::Pubkey>,
                ...
                dca_ata: Option<solana_program::pubkey::Pubkey>,
                ...
                program: Option<solana_program::pubkey::Pubkey>,
                        withdraw_params: Option<WithdrawParams>,
...
impl WithdrawBuilder {
  pub fn new() -> Self {
    ...
    pub fn dca_ata(&mut self, dca_ata: solana_program::pubkey::Pubkey) -> &mut Self {
            ...
            /// `[optional account]`
#[inline(always)]
    pub fn user_in_ata(&mut self, user_in_ata: Option<solana_program::pubkey::Pubkey>) -> &mut Self {
...
#[inline(always)]
    ...
    pub fn program(&mut self, program: solana_program::pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn withdraw_params(&mut self, withdraw_params: WithdrawParams) -> &mut Self {
        self.withdraw_params = Some(withdraw_params);
        self
      }
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = Withdraw {
                              user: self.user.expect("user is not set"),
                                        ...
                                        dca_ata: self.dca_ata.expect("dca_ata is not set"),
                                        user_in_ata: self.user_in_ata,
          ...
          let args = WithdrawInstructionArgs {
                                                              withdraw_params: self.withdraw_params.clone().expect("withdraw_params is not set"),
                                    };
  ...
  pub struct WithdrawCpiAccounts<'a, 'b> {
              ...
              pub dca_ata: &'b solana_program::account_info::AccountInfo<'a>,
                
                    
              pub user_in_ata: Option<&'b solana_program::account_info::AccountInfo<'a>>,
  ...
  pub fn invoke_signed_with_remaining_accounts(
    ...
    account_infos.push(self.__program.clone());
                  account_infos.push(self.user.clone());
                        ...
                        account_infos.push(self.dca_ata.clone());
                        if let Some(user_in_ata) = self.user_in_ata {
          account_infos.push(user_in_ata.clone());
        }
                        if let Some(user_out_ata) = self.user_out_ata {
...
impl<'a, 'b> WithdrawCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn output_mint(&mut self, output_mint: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn dca_ata(&mut self, dca_ata: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                        self.instruction.dca_ata = Some(dca_ata);
                    self
    }
      /// `[optional account]`
#[inline(always)]
    pub fn user_in_ata(&mut self, user_in_ata: Option<&'b solana_program::account_info::AccountInfo<'a>>) -> &mut Self {
...
#[inline(always)]
    ...
    pub fn program(&mut self, program: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn withdraw_params(&mut self, withdraw_params: WithdrawParams) -> &mut Self {
        self.instruction.withdraw_params = Some(withdraw_params);
        self
      }
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = WithdrawInstructionArgs {
                                                              withdraw_params: self.instruction.withdraw_params.clone().expect("withdraw_params is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          dca_ata: self.instruction.dca_ata.expect("dca_ata is not set"),
                  
          user_in_ata: self.instruction.user_in_ata,
...
struct WithdrawCpiBuilderInstruction<'a, 'b> {
  __program: &'b solana_program::account_info::AccountInfo<'a>,
            user: Option<&'b solana_program::account_info::AccountInfo<'a>>,
                ...
                dca_ata: Option<&'b solana_program::account_info::AccountInfo<'a>>,
