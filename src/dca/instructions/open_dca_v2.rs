...
impl OpenDcaV2 {
  pub fn instruction(&self, args: OpenDcaV2InstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: OpenDcaV2InstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = OpenDcaV2InstructionData::new().try_to_vec().unwrap();
...
pub struct OpenDcaV2InstructionData {
            discriminator: [u8; 8],
                                                }

impl OpenDcaV2InstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [142, 119, 43, 109, 162, 52, 11, 177],
                                                                                                                    }
  }
}

impl Default for OpenDcaV2InstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
pub struct OpenDcaV2InstructionArgs {
...
/// Instruction builder for `OpenDcaV2`.
///
/// ### Accounts:
///
                ///   0. `[writable]` dca
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = OpenDcaV2 {
          ...
          let args = OpenDcaV2InstructionArgs {
                                                              application_idx: self.application_idx.clone().expect("application_idx is not set"),
                                                                  in_amount: self.in_amount.clone().expect("in_amount is not set"),
                                                                  in_amount_per_cycle: self.in_amount_per_cycle.clone().expect("in_amount_per_cycle is not set"),
                                                                  cycle_frequency: self.cycle_frequency.clone().expect("cycle_frequency is not set"),
  ...
  /// `open_dca_v2` CPI accounts.
  pub struct OpenDcaV2CpiAccounts<'a, 'b> {
...
/// `open_dca_v2` CPI instruction.
pub struct OpenDcaV2Cpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: OpenDcaV2InstructionArgs,
  }

impl<'a, 'b> OpenDcaV2Cpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: OpenDcaV2CpiAccounts<'a, 'b>,
              args: OpenDcaV2InstructionArgs,
      ) -> Self {
    Self {
      __program: program,
              dca: accounts.dca,
...
/// Instruction builder for `OpenDcaV2` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` dca
          ...
          ///   12. `[]` program
#[derive(Clone, Debug)]
pub struct OpenDcaV2CpiBuilder<'a, 'b> {
  instruction: Box<OpenDcaV2CpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> OpenDcaV2CpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(OpenDcaV2CpiBuilderInstruction {
      __program: program,
              dca: None,
              user: None,
              payer: None,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = OpenDcaV2InstructionArgs {
                                                              application_idx: self.instruction.application_idx.clone().expect("application_idx is not set"),
                                                                  in_amount: self.instruction.in_amount.clone().expect("in_amount is not set"),
                                                                  in_amount_per_cycle: self.instruction.in_amount_per_cycle.clone().expect("in_amount_per_cycle is not set"),
                                                                  cycle_frequency: self.instruction.cycle_frequency.clone().expect("cycle_frequency is not set"),
...
#[derive(Clone, Debug)]
struct OpenDcaV2CpiBuilderInstruction<'a, 'b> {
